...
public class WeatheringCopperFanBlock extends CopperFanBlock implements WeatheringCopper {
	...
	@Override
	public MapCodec<? extends WeatheringCopperFanBlock> codec() {
		return CODEC;
	}

	public WeatheringCopperFanBlock(WeatheringCopper.WeatherState weatherState, Properties properties) {

...
public class CopperGolemSpecificSensor extends Sensor<CopperGolem> {
	...
	public Set<MemoryModuleType<?>> requires() {
		return ImmutableSet.of(
			TCAMemoryModuleTypes.UNREACHABLE_BUTTON_PRESS_BLOCK_POSITIONS.get(),
			TCAMemoryModuleTypes.NEARBY_BUTTON_SEARCH_TICKS.get(),
			TCAMemoryModuleTypes.NEARBY_COPPER_GOLEMS.get(),
	...
	protected void doTick(ServerLevel level, CopperGolem body) {
		...
		brain.setMemory(TCAMemoryModuleTypes.NEARBY_COPPER_GOLEMS.get(), copperGolems);
	}
}

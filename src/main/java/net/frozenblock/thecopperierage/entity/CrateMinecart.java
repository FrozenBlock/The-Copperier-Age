...
public class CrateMinecart extends AbstractMinecartContainer {
	...
	protected Item getDropItem() {
		return TCAItems.CRATE_MINECART;
	}
	...
	public BlockState getDefaultDisplayBlockState() {
		return TCABlocks.CRATE.unaffected()
			.defaultBlockState()
	...
	private void playCrateSound(boolean opening) {
		...
		final SoundEvent sound = opening
			? ((CrateBlock) TCABlocks.CRATE.unaffected()).getOpenSound()
			: ((CrateBlock) TCABlocks.CRATE.unaffected()).getCloseSound();

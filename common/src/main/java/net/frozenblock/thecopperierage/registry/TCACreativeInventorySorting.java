...
public final class TCACreativeInventorySorting {
	...
	public static void setup() {
		...
		insertAfterInBuildingBlocks(Items.COPPER_BULB.weathering().oxidized(), TCAItems.GEARBOX.weathering().unaffected());
		insertAfterInBuildingBlocks(TCAItems.GEARBOX.weathering().unaffected(), TCAItems.GEARBOX.weathering().exposed());
		insertAfterInBuildingBlocks(TCAItems.GEARBOX.weathering().exposed(), TCAItems.GEARBOX.weathering().weathered());
		insertAfterInBuildingBlocks(TCAItems.GEARBOX.weathering().weathered(), TCAItems.GEARBOX.weathering().oxidized());

		insertAfterInBuildingBlocks(TCAItems.GEARBOX.weathering().oxidized(), TCAItems.STICKY_GEARBOX.weathering().unaffected());
		insertAfterInBuildingBlocks(TCAItems.STICKY_GEARBOX.weathering().unaffected(), TCAItems.STICKY_GEARBOX.weathering().exposed());
		insertAfterInBuildingBlocks(TCAItems.STICKY_GEARBOX.weathering().exposed(), TCAItems.STICKY_GEARBOX.weathering().weathered());
		insertAfterInBuildingBlocks(TCAItems.STICKY_GEARBOX.weathering().weathered(), TCAItems.STICKY_GEARBOX.weathering().oxidized());

		insertAfterInBuildingBlocks(Items.COPPER_BULB.waxed().oxidized(), TCAItems.GEARBOX.waxed().unaffected());
		insertAfterInBuildingBlocks(TCAItems.GEARBOX.waxed().unaffected(), TCAItems.GEARBOX.waxed().exposed());
		insertAfterInBuildingBlocks(TCAItems.GEARBOX.waxed().exposed(), TCAItems.GEARBOX.waxed().weathered());
		insertAfterInBuildingBlocks(TCAItems.GEARBOX.waxed().weathered(), TCAItems.GEARBOX.waxed().oxidized());

		insertAfterInBuildingBlocks(TCAItems.GEARBOX.waxed().oxidized(), TCAItems.STICKY_GEARBOX.waxed().unaffected());
		insertAfterInBuildingBlocks(TCAItems.STICKY_GEARBOX.waxed().unaffected(), TCAItems.STICKY_GEARBOX.waxed().exposed());
		insertAfterInBuildingBlocks(TCAItems.STICKY_GEARBOX.waxed().exposed(), TCAItems.STICKY_GEARBOX.waxed().weathered());
		insertAfterInBuildingBlocks(TCAItems.STICKY_GEARBOX.waxed().weathered(), TCAItems.STICKY_GEARBOX.waxed().oxidized());

		// FAN
		insertBeforeInRedstoneBlocks(Items.RAIL, TCAItems.COPPER_FAN.waxed().unaffected());

		insertAfterInBuildingBlocks(TCAItems.STICKY_GEARBOX.weathering().oxidized(), TCAItems.COPPER_FAN.weathering().unaffected());
		insertAfterInBuildingBlocks(TCAItems.COPPER_FAN.weathering().unaffected(), TCAItems.COPPER_FAN.weathering().exposed());
		insertAfterInBuildingBlocks(TCAItems.COPPER_FAN.weathering().exposed(), TCAItems.COPPER_FAN.weathering().weathered());
		insertAfterInBuildingBlocks(TCAItems.COPPER_FAN.weathering().weathered(), TCAItems.COPPER_FAN.weathering().oxidized());

		insertAfterInBuildingBlocks(TCAItems.STICKY_GEARBOX.waxed().oxidized(), TCAItems.COPPER_FAN.waxed().unaffected());
		insertAfterInBuildingBlocks(TCAItems.COPPER_FAN.waxed().unaffected(), TCAItems.COPPER_FAN.waxed().exposed());
		insertAfterInBuildingBlocks(TCAItems.COPPER_FAN.waxed().exposed(), TCAItems.COPPER_FAN.waxed().weathered());
		insertAfterInBuildingBlocks(TCAItems.COPPER_FAN.waxed().weathered(), TCAItems.COPPER_FAN.waxed().oxidized());
		...
		insertAfterInBuildingBlocks(TCAItems.COPPER_FAN.weathering().oxidized(), TCAItems.CHIME.weathering().unaffected());
		insertAfterInBuildingBlocks(TCAItems.CHIME.weathering().unaffected(), TCAItems.CHIME.weathering().exposed());
		insertAfterInBuildingBlocks(TCAItems.CHIME.weathering().exposed(), TCAItems.CHIME.weathering().weathered());
		insertAfterInBuildingBlocks(TCAItems.CHIME.weathering().weathered(), TCAItems.CHIME.weathering().oxidized());

		insertAfterInBuildingBlocks(TCAItems.COPPER_FAN.waxed().oxidized(), TCAItems.CHIME.waxed().unaffected());
		insertAfterInBuildingBlocks(TCAItems.CHIME.waxed().unaffected(), TCAItems.CHIME.waxed().exposed());
		insertAfterInBuildingBlocks(TCAItems.CHIME.waxed().exposed(), TCAItems.CHIME.waxed().weathered());
		insertAfterInBuildingBlocks(TCAItems.CHIME.waxed().weathered(), TCAItems.CHIME.waxed().oxidized());
		...
		insertAfterInBuildingBlocks(Items.COPPER_TRAPDOOR.weathering().oxidized(), TCAItems.WEIGHTED_PRESSURE_PLATE.weathering().unaffected());
		insertAfterInBuildingBlocks(TCAItems.WEIGHTED_PRESSURE_PLATE.weathering().unaffected(), TCAItems.WEIGHTED_PRESSURE_PLATE.weathering().exposed());
		insertAfterInBuildingBlocks(TCAItems.WEIGHTED_PRESSURE_PLATE.weathering().exposed(), TCAItems.WEIGHTED_PRESSURE_PLATE.weathering().weathered());
		insertAfterInBuildingBlocks(TCAItems.WEIGHTED_PRESSURE_PLATE.weathering().weathered(), TCAItems.WEIGHTED_PRESSURE_PLATE.weathering().oxidized());

		insertAfterInBuildingBlocks(Items.COPPER_TRAPDOOR.waxed().oxidized(), TCAItems.WEIGHTED_PRESSURE_PLATE.waxed().unaffected());
		insertAfterInBuildingBlocks(TCAItems.WEIGHTED_PRESSURE_PLATE.waxed().unaffected(), TCAItems.WEIGHTED_PRESSURE_PLATE.waxed().exposed());
		insertAfterInBuildingBlocks(TCAItems.WEIGHTED_PRESSURE_PLATE.waxed().exposed(), TCAItems.WEIGHTED_PRESSURE_PLATE.waxed().weathered());
		insertAfterInBuildingBlocks(TCAItems.WEIGHTED_PRESSURE_PLATE.waxed().weathered(), TCAItems.WEIGHTED_PRESSURE_PLATE.waxed().oxidized());
		...
		insertAfterInBuildingBlocks(TCAItems.WEIGHTED_PRESSURE_PLATE.weathering().oxidized(), TCAItems.COPPER_BUTTON.weathering().unaffected());
		insertAfterInBuildingBlocks(TCAItems.COPPER_BUTTON.weathering().unaffected(), TCAItems.COPPER_BUTTON.weathering().exposed());
		insertAfterInBuildingBlocks(TCAItems.COPPER_BUTTON.weathering().exposed(), TCAItems.COPPER_BUTTON.weathering().weathered());
		insertAfterInBuildingBlocks(TCAItems.COPPER_BUTTON.weathering().weathered(), TCAItems.COPPER_BUTTON.weathering().oxidized());

		insertAfterInBuildingBlocks(TCAItems.WEIGHTED_PRESSURE_PLATE.waxed().oxidized(), TCAItems.COPPER_BUTTON.waxed().unaffected());
		insertAfterInBuildingBlocks(TCAItems.COPPER_BUTTON.waxed().unaffected(), TCAItems.COPPER_BUTTON.waxed().exposed());
		insertAfterInBuildingBlocks(TCAItems.COPPER_BUTTON.waxed().exposed(), TCAItems.COPPER_BUTTON.waxed().weathered());
		insertAfterInBuildingBlocks(TCAItems.COPPER_BUTTON.waxed().weathered(), TCAItems.COPPER_BUTTON.waxed().oxidized());

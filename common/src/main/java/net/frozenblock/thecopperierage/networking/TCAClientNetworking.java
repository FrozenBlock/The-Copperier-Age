...
public final class TCAClientNetworking {
	...
	public static void receiveCopperFanBlowPacket() {
		ClientNetworkingHelper.registerGlobalClientReceiver(TCACopperFanBlowPacket.PACKET_TYPE, (packet, minecraft, player) -> {
	...
	public static void receiveChimeInfluencePacket() {
		ClientNetworkingHelper.registerGlobalClientReceiver(TCAChimeInfluencePacket.PACKET_TYPE, (packet, minecraft, player) -> {
			final ClientLevel level = minecraft.level;
			if (level == null) return;

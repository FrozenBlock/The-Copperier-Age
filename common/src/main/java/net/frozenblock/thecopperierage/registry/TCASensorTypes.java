...
public final class TCASensorTypes {
	private static final DeferredRegister.SensorTypes REGISTER = DeferredRegister.createSensorTypes(TCAConstants.MOD_ID);

	public static final DeferredSensorType<CopperGolemSpecificSensor> COPPER_GOLEM_SPECIFIC_SENSOR = register("copper_golem_specific_sensor", CopperGolemSpecificSensor::new);

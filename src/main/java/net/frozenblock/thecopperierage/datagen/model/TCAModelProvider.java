...
public final class TCAModelProvider extends FabricModelProvider {
	...
	public void generateBlockStateModels(@NotNull BlockModelGenerators generator) {
		...
		generator.createWeightedPressurePlate(TCABlocks.COPPER_PRESSURE_PLATE.unaffected(), Blocks.COPPER_BLOCK);
		generator.createWeightedPressurePlate(TCABlocks.COPPER_PRESSURE_PLATE.waxed(), Blocks.COPPER_BLOCK);
		generator.createWeightedPressurePlate(TCABlocks.COPPER_PRESSURE_PLATE.exposed(), Blocks.EXPOSED_COPPER);
		generator.createWeightedPressurePlate(TCABlocks.COPPER_PRESSURE_PLATE.waxedExposed(), Blocks.EXPOSED_COPPER);
		generator.createWeightedPressurePlate(TCABlocks.COPPER_PRESSURE_PLATE.weathered(), Blocks.WEATHERED_COPPER);
		generator.createWeightedPressurePlate(TCABlocks.COPPER_PRESSURE_PLATE.waxedWeathered(), Blocks.WEATHERED_COPPER);
		generator.createWeightedPressurePlate(TCABlocks.COPPER_PRESSURE_PLATE.oxidized(), Blocks.OXIDIZED_COPPER);
		generator.createWeightedPressurePlate(TCABlocks.COPPER_PRESSURE_PLATE.waxedOxidized(), Blocks.OXIDIZED_COPPER);

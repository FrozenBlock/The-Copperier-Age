...
public class FurnaceMinecartScreen extends AbstractContainerScreen<FurnaceMinecartMenu> {
	private static final ResourceLocation BACKGROUND_TEXTURE = TCAConstants.id("textures/gui/container/furnace_minecart.png");
	...
	private void renderLitProgress(GuiGraphics guiGraphics) {

...
public class MinecartCopperGolemStatue extends AbstractMinecart {
	...
	public MinecartCopperGolemStatue(Level level, double x, double y, double z) {
		this(TCAEntityTypes.COPPER_GOLEM_STATUE_MINECART.get(), level);
		this.setPos(x, y, z);
	}

	@Override
	protected Item getDropItem() {
		return TCAItems.COPPER_GOLEM_STATUE_MINECART.get();
	}
	...
	public BlockState getDefaultDisplayBlockState() {
		return Blocks.COPPER_GOLEM_STATUE.weathering().unaffected().defaultBlockState();
	}

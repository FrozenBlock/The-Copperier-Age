...
public class KilnScreen extends AbstractRecipeBookScreen<KilnMenu> {
	...
	private final ResourceLocation litProgressSprite = LIT_PROGRESS_SPRITE;
	private final ResourceLocation burnProgressSprite = BURN_PROGRESS_SPRITE;
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
		...
		guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, this.burnProgressSprite, 24, 16, 0, 0, x + 79, y + 34, burnProgress, 16);
	}
}
